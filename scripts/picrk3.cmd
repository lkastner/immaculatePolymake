...
$R3 = new Set<Int>(3,4);
$R4 = new Set<Int>(4,0);
$Cemp = rk3_build_cone_for_tempting($p0,$p1, $c, $b, $p4, $Remp);
$C0 = rk3_build_cone_for_tempting($p0,$p1, $c, $b, $p4, $R0);
$C1 = rk3_build_cone_for_tempting($p0,$p1, $c, $b, $p4, $R1);
$C2 = rk3_build_cone_for_tempting($p0,$p1, $c, $b, $p4, $R2);
$C3 = rk3_build_cone_for_tempting($p0,$p1, $c, $b, $p4, $R3);
$C4 = rk3_build_cone_for_tempting($p0,$p1, $c, $b, $p4, $R4);
print rk3_maculate_vertex_for_tempting($p0,$p1, $c, $b, $p4, $Remp);
print $Cemp->FACETS;
print rk3_maculate_vertex_for_tempting($p0,$p1, $c, $b, $p4, $R0);
print $C0->FACETS;
print rk3_maculate_vertex_for_tempting($p0,$p1, $c, $b, $p4, $R1);
print $C1->FACETS;
print rk3_maculate_vertex_for_tempting($p0,$p1, $c, $b, $p4, $R2);
print $C2->FACETS;
print rk3_maculate_vertex_for_tempting($p0,$p1, $c, $b, $p4, $R3);
print $C3->FACETS;
print rk3_maculate_vertex_for_tempting($p0,$p1, $c, $b, $p4, $R4);
print $C4->FACETS;
